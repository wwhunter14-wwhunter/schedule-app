...
export default function MonthGrid({ viewDate, events, selectedDate, onDateSelect }: Props) {
        ...
        {days.map((day) => {
          ...
          return (
            <div
              ...
              className={`min-h-[100px] p-1.5 border-r border-b border-slate-100 dark:border-slate-800 last:border-r-0 cursor-pointer transition-colors ${
                isSelected
              ...
              <div className="space-y-0.5" onClick={(e) => e.stopPropagation()}>
                {visibleEvents.map((e) => (
                  <Link
                    ...
                    className="flex items-center gap-1 px-1 py-0.5 rounded text-xs hover:bg-white dark:hover:bg-slate-800 transition-colors group"
                  >
                    <span
